              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ==== BOTTOM ACTIONS (History & Help) ====
                    Align(
                      alignment: Alignment.centerRight,
                      child: Row(
                        mainAxisSize: MainAxisSize.min, // Keep tight to right
                        children: [
                          ...
                          IconButton(
                            ...
                            icon: const Icon(
                              Icons.history,
                              color: Color(0xFF687890), // Matches text color
                            ),
                          ),
            ...
            child: Column(
              ...
              children: [
                _buildHelpStep(
                  ...
                  description:
                      "Fill in the client's name, email, and location to create a profile.",
                ),
                const Gap(24),
                _buildHelpStep(
                  number: "2",
                  title: "Start Session",
                  description:
                      "Click the 'Start Session' button to generate a unique Project ID and proceed to image upload.",
                ),
              ],
            ),
          ),
