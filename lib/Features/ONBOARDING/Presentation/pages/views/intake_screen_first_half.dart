  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Container(
        ...
        padding: const EdgeInsets.only(left: 80, right: 80 , bottom: 80  , top : 80),
        ...
        child: Column(
          ...
          children: [
            ...
            Row (
              children: [
                Image.asset('assets/Images/appicon.png' , width: 40 ,height: 40,),
                Gap(10) , 
                Text('Iris designer' , style: GoogleFonts.poppins(textStyle: TextStyle(
            ...
            Text(
              ...
              style: GoogleFonts.poppins(
                textStyle: TextStyle(height: 1 ,fontSize: 40, fontWeight: FontWeight.bold),
              ),
            ),
